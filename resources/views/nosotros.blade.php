...
@section('content')
      ...
      <div class="container mt-6">
        <section class="mb-4">
          <h2 class="text-center no-mt mb-6 wow fadeInUp">Valores Corporativos</h2>
          <div class="row">
            <div class="col-lg-4 col-md-6 col-sm-6 mb-2">
              <div class="ms-icon-feature wow flipInX animation-delay-4">
                ...
                <div class="ms-icon-feature-content">
                  <h4 class="color-primary">Honestidad</h4>
                  <p>Respetamos la verdad y la anteponemos a todas las cosas. Obramos con justicia, rectitud e integridad, en las distintas actividades que desarrollamos.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 mb-2">
              <div class="ms-icon-feature wow flipInX animation-delay-4">
                ...
                <div class="ms-icon-feature-content">
                  <h4 class="color-primary">Lealtad</h4>
                  <p>Permanecemos fieles a los principios, a las políticas y a los procesos en el desarrollo de nuestras labores aun en circunstancias adversas.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 mb-2">
              <div class="ms-icon-feature wow flipInX animation-delay-4">
                ...
                <div class="ms-icon-feature-content">
                  <h4 class="color-primary">Integridad</h4>
                  <p>Actuamos con transparencia y responsabilidad.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 mb-2">
              <div class="ms-icon-feature wow flipInX animation-delay-4">
                ...
                <div class="ms-icon-feature-content">
                  <h4 class="color-primary">Liderazgo</h4>
                  <p>Transformamos las ideas en resultados.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 mb-2">
              <div class="ms-icon-feature wow flipInX animation-delay-4">
                ...
                <div class="ms-icon-feature-content">
                  <h4 class="color-primary">Profesionalismo</h4>
                  <p>Cumplimos con los compromisos y retos, imprimiendo en ellos nuestras habilidades y conocimientos, con calidad humana.</p>
                </div>
              </div>
            </div>
            <div class="col-lg-4 col-md-6 col-sm-6 mb-2">
              <div class="ms-icon-feature wow flipInX animation-delay-4">
                ...
                <div class="ms-icon-feature-content">
                  <h4 class="color-primary">Compromiso</h4>
                  <p>Tenemos sentido de pertenencia que nos motiva a lograr las metas propuestas.</p>
                </div>
              </div>
            </div>
          </div>
